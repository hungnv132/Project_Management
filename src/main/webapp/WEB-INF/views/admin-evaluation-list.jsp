	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
        	...
        	<c:out value="${d}"></c:out>  --%>
				...
				<div style="width:250px; margin-top: 10px;" class="pull-right ">
					<a href="/admin/manage-user"><button class="btn btn-primary pull-right" id="add-new-staff" style="margin: 0px 20px 10px 0px;" >Quay lại</button></a>
					<input class="form-control search-input" style="font-size: 16px;margin-top: 10px;" type="search" placeholder="tìm kiếm dự án " >
				</div>
	...
	<script type="text/javascript">
		$(document).ready(
				function() {
					...
					var tblEvaluation = $('#tblEvaluation').DataTable(
							{
								...
								"ajax" : {
									"url" : "/admin/get-all-evaluations/"+ userId,
									"type" : "POST",
									 "data": function(data){
								 ...
								 "columnDefs" : [ {
									...
									"render" : function(id, type, full, meta) {
										...
										var finalButton =  '<a href="/admin/evaluation/'+ id +'/view"  class="btn  btn-action" > Xem  </a>';
					...
					tblEvaluation.ajax.url('/admin/get-all-evaluations/'+ userId).load();
