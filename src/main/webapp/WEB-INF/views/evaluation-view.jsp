...
<joda:format pattern="dd-MM-yyyy" value="${evaluation.createAt}" var="createAt" />  
<style>
</style>
</head>
<body class="skin-blue sidebar-mini">
					...
					<div class="my-box-100 evaluation-box">
						...
						<div class="row" style="margin-top: 10px;">
								<div class="col-xs-5 my-col" style="border-right: 1px solid #f39c12;">
									...
									<div class="field-box row">
										...
										<%-- 	<div class='input-group date datePicker'>
											...
											<span class="my-label createAt">${createAt }</span>
										</div>
									</div>
									<div class="field-box row">
										<div class="col-xs-4">
										...
										<div class="col-xs-8">
											...
											<span class="my-label fullName">${evaluation.staff.firstName } ${evaluation.staff.midName } ${evaluation.staff.lastName } </span>
										</div>
									</div>
									<div class="field-box row">
										<div class="col-xs-4">
										...
										<span class="my-label projectName">${evaluation.project.name}</span>
										</div>
									</div>
									...
									<div class="field-box ">
										<div class="tag-box">
											...
											<div class="tag-area">
												<c:forEach items="${trainingCourseAttended }" var="course" >
													<span class="my-tag"><span class="tag-value ">${course }</span></span>
												</c:forEach>
											</div>
										</div>
									</div>
									<div class="field-box ">
										<div class="tag-box">
												...
												<div class=" tag-area">
													...
													<span class="my-tag"><span class="tag-value ">${cer }</span></span>
												</c:forEach>
												</div>
										</div>
									</div>
									<%-- <div class="field-box">
										<div class="tag-box">
											...
											<div class=" tag-area">
												<c:forEach items="${languageScope }" var="language" >
													<span class="my-tag"><span class="tag-value ">${language }</span></span>
												</c:forEach>
											</div>
										</div>
									</div> --%>
								...
								<div class="col-xs-7 my-col">
									...
									<div class="field-box field-box-1">
									 ...
									 <div class="field-box field-box-1">
										...
										<%-- <form:textarea path="performanceComment" cssErrorClass="has-error form-control " cssClass="form-control " rows="5"/>
										<form:errors path="performanceComment" cssClass="form-error" /> --%>
										<textarea name="performanceComment" class="form-control "  rows="5">${evaluation.comment }</textarea>
									</div>
								...
								<div class="col-xs-6 my-col">
										...
										<div class="field-box row">
											<div class="col-xs-12">
												...
												<%-- <form:textarea path="penalty" cssErrorClass="has-error form-control" cssClass="form-control " rows="4"/>
							...
							<div class="row">
								...
								<div class="col-xs-5">
									<a href="/manager/evaluation/${evaluation.id}/edit" class="btn btn-primary">Thay đổi</a>
								</div>
							</div>
				...
				<%-- <form:form action="/manager/evaluation/create" method="post" commandName="evaluationForm">
					...
					<div class="my-box">
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<!-- <textarea rows="2"   class="form-control " name="performanceComment"></textarea> -->
								<form:textarea path="performanceComment" cssErrorClass="has-error form-control " cssClass="form-control  "/>
								<form:errors path="performanceComment" cssClass="form-error" />
							</div>
						</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var raty_taskCompletion = ${evaluation.taskCompletion};
			var raty_taskComplexity = ${evaluation.taskComplexity};
			var raty_workingDiscipline = ${evaluation.workingDiscipline};
			var raty_skill = ${evaluation.skill};
			var raty_behavior = ${evaluation.behavior};
