	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
        	...
        	<c:out value="${d}"></c:out>  --%>
				...
				<h3>Danh sách các yêu cầu các nhân viên: </h3>
						...
						<div style="margin-top: 10px;">
							<table class="table table-striped">
		                  	...
		                  	<div>
								...
								<form>
						              <textarea name="comment" class="form-control comment" placeholder="Viết vài nhận xét " style="font-style:italic; width: 100%; height: 120px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
						         </form>
		                  	</div>
	...
	<script type="text/javascript">
		$(document).ready(
				function() {
					...
					tblRequest.ajax.url('/manager/get-all-requests').load();
					...
					$('#tblRequest').on('click', 'tbody tr #btnDetail', function(event) {
						...
						$("#detail-request").on("shown.bs.modal", function(){		
							$('#detail-request textarea.comment').focus();
						});
					});
								...
								success : function(response) {
									console.log(response);
									 if (response.status == 'SUCCESS') {
										waiting("hide");
										showAlertBox("Thành công","success", "/manager/requests");
									} else {
										waiting("hide");
										 showAlertBox("Có lỗi xảy ra","falied", "/manager/requests" );
									} 
								},
